...
public class MainActivity extends AppCompatActivity implements CategoryAdapter_RV.CategoryClickInterface{
    ...
    private void getCategories(){
        ...
        categoryModalRVArrayList.add(new CategoryModal_RV("General","https://images.unsplash.com/photo-1432821596592-e2c18b78144f?ixid=MnwxMjA3fDB8MHxzZWFyY2h8MjB8fGdlbmVyYWx8ZW58MHx8MHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=60"));
